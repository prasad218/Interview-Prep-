  ...
  return (
    <div className="relative inline-flex items-center">
      ...
      <select
        ...
        className="appearance-none bg-base-800 border border-base-600 hover:border-base-500 text-ink-100 text-xs rounded-lg pl-6 pr-7 py-1.5 outline-none cursor-pointer transition-colors focus:border-accent"
      >
        {models.map((m) => (
